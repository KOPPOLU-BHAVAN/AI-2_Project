...
class Player:
    ...
    def __init__(self, playerId, startingY):
        ...
        self.image = pygame.image.load("bird.png")  # Ensure bird.png is in the same directory
        self.image = pygame.transform.scale(self.image, (50, 50))  # Scale the image to fit the player size
        self.network = Network((2, 3, 1), (Sigmoid, Sigmoid, Sigmoid))
    ...
    def draw(self, screen, scrollDistance):
        ...
        screen.blit(self.image, (self.x - scrollDistance, self.y))
